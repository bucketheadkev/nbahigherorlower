...
const APP_LOCAL_STORAGE_KEYS = [
  ...
  'oneb_challenges_v1',
  'oneb_challenges_cloud_owner_v1',
  'oneb_challenges_materialize_ok_v1',
  'oneb_challenges_migrate_source_v1',
  'oneb_classic_cloud_owner_v1',
  'oneb_classic_migrate_source_v1',
  'oneb_guest_classic_snapshot_v1',
  '1brun_account_prompt_seen_v1',
  'tradeup_muted',
